...
const LayerTag = ({ layerNumber, input_direction }) => {
    ...
    const directionClassName = clsx({
        ...
        'layer-tag-default flex flex-row self-start ': input_direction !== "left" || "right",
        'layer-tag-left flex flex-row self-start ': input_direction === "left",
        'layer-tag-right flex  flex-row ': input_direction === "right"

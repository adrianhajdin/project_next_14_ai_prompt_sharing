...
import LayerTag from 'public/assets/icons/generic/layer.svg';
    ...
    return (
        ...
        >
            <div className="flex flex-row gap-[4px]">
                {/* <LayerTag className={layerTagClassNames} /> */}
                <div className="self-center ">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={14}
                        height={15}
                    // fill={layerIconClassNames}
                    >
